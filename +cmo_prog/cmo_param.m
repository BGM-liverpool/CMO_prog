...
param.kqp   = 0.1;  % dimentionless
param.km    = 0.2;  % umolP/L, half-saturation constant for enzyme kienetics

%% 
param.klys =0.003*24; % unit: /d, specific rate of lysis at opt.T with 
                      %           no nutrient limitation
%% 
param.lamda_dop=0.32; % unit: /d, rate of DOP remineralization to DIP 
%%
